...
const Connecting = () => {
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
                ...
                <p className="text-lg text-gray-600 max-w-md text-center">
                    We're matching your interests with the best minds. Hang tight—this magic takes a moment!
                </p>
    ...
    const sortedEducators = [...educator].sort(
                    ...
                    {sortedEducators.map((edu, index) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                {edu.educatorSkills && edu.educatorSkills.length > 0 && (
                                    <div className="mb-4">
                                        <h4 className="text-sm font-semibold text-gray-700 mb-2">Skills:</h4>
                                        <div className="flex flex-wrap gap-2">
                                            {edu.educatorSkills.map((skill, i) => (
                                                <span key={i} className="px-3 py-1 bg-indigo-100 text-indigo-800 text-sm font-medium rounded-full">
                                                    {skill}
                                                </span>
                                            ))}
                                        </div>
                            ...
                            <div className="px-6 pb-6">
                                <button
                                    onClick={() =>
                                        window.location.href = `/educator/${edu.educatorId}`
                                    }
